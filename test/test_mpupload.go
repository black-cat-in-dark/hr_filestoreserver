...
func main() {
	username := "admin"
	token := "82d74f4ff67992471f55c6a8d1eeda4a5fc5db9d"
	filehash := "589eab0bf9f2297c59ff0e3bc7717e31db4e3506"
	...
	// 3. 请求分块上传接口
	filename := "../tmp/open it everyday.txt"
	...
	resp, err = http.PostForm(
		...
		url.Values{
			...
			"filehash": {filehash},
			"filesize": {"1995"},
			"filename": {"open it everyday-mpupload.txt"},
			"uploadid": {uploadID},
		})
